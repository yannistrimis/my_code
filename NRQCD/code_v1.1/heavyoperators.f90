...
! - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
 ...
 subroutine Smeson(G1,corr1s0,corr3s1)
...
!   corr3s1x/y/z are the correlation functions for ^3S_1 (1--).
    ...
    complex(kind=KC), intent(out)                         :: corr3s1

    complex(kind=KC)                                      :: corr3s1x 
    complex(kind=KC)                                      :: corr3s1y 
    complex(kind=KC)                                      :: corr3s1z 
    ...
    corr3s1 = ( corr3s1x + corr3s1y + corr3s1z ) / 3.0_KR
