...
#    prior['log(an)'] = gv.log(gv.gvar(['15.30(1000.0)', '2.00(1000.0)']))
#    prior['log(dEn)'] = gv.log(gv.gvar(['0.569(100.0)', '1.00(100.0)']))
    prior['log(an)'] = gv.log(gv.gvar(N*['1.2638(1000.0)']))
    prior['log(dEn)'] = gv.log(gv.gvar(N*['0.3113(1000.0)']))
    prior['log(ao)'] = gv.log(gv.gvar(M*['0.4183(1000.0)']))
    prior['log(dEo)'] = gv.log(gv.gvar(M*['0.4615(1000.0)']))
