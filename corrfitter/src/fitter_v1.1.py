...
def make_prior(N,M):
    ...
    if N == 0 or N == 1 :
        ...
        prior['log(an)'] = gv.log(gv.gvar(['16.4(10000.0)']))
        prior['log(dEn)'] = gv.log(gv.gvar(['0.2827(10000.0)']))
    ...
    if M == 0 or M == 1 :
        ...
        prior['log(ao)'] = gv.log(gv.gvar(['4.45(10000.0)']))
        prior['log(dEo)'] = gv.log(gv.gvar(['0.50(10000.0)']))
