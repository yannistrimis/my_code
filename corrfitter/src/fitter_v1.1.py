...
#    prior['log(dEn)'] = gv.log(gv.gvar(['0.569(100.0)', '1.00(100.0)']))
    prior['log(an)'] = gv.log(gv.gvar(N*['0.2598(1000.0)']))
    prior['log(dEn)'] = gv.log(gv.gvar(N*['0.3532(1000.0)']))
    prior['log(ao)'] = gv.log(gv.gvar(M*['0.1410(1000.0)']))
    prior['log(dEo)'] = gv.log(gv.gvar(M*['0.1410(1000.0)']))
