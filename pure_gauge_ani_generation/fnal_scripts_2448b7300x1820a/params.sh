...
beta_s=4.01099 #in the MILC colde this appears first
beta_t=13.28600 #and this appears second
...
ensemble="2448b7300x1820a"
lat_name="l2448b7300x1820a"
out_name="out2448b7300x1820a"
...
run_dir="/project/ahisq/yannis_puregauge/runs/rungenl2448b7300x1820a"
submit_dir="/project/ahisq/yannis_puregauge/submits/subgenl2448b7300x1820a"
