...
beta_s=3.88298 #in the MILC colde this appears first
beta_t=13.72400 #and this appears second
...
ensemble="2448b7300x1880a"
lat_name="l2448b7300x1880a"
out_name="out2448b7300x1880a"
...
run_dir="/project/ahisq/yannis_puregauge/runs/rungenl2448b7300x1880a"
submit_dir="/project/ahisq/yannis_puregauge/submits/subgenl2448b7300x1880a"
