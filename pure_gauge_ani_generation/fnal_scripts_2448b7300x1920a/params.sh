...
beta_s=3.80208 #in the MILC colde this appears first
beta_t=14.01600 #and this appears second
...
ensemble="2448b7300x1920a"
lat_name="l2448b7300x1920a"
out_name="out2448b7300x1920a"
...
run_dir="/project/ahisq/yannis_puregauge/runs/rungenl2448b7300x1920a"
submit_dir="/project/ahisq/yannis_puregauge/submits/subgenl2448b7300x1920a"
