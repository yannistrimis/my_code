...
ensemble="88b6850x100h"
lat_name="l88b6850x100h"
out_name="out88b6850x100h"
...
run_dir="/project/ahisq/yannis_puregauge/runs/rungenl88b6850x100h"
submit_dir="/project/ahisq/yannis_puregauge/submits/subgenl88b6850x100h"
