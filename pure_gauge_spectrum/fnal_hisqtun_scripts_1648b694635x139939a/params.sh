...
out_name="spechisqtun1648b694635x139939"

nmasses=4
mass_arr=( 0.03 0.05 0.07 0.09   )

nxq=4
xq_arr=( 1.05 1.25 1.45 1.65   )
xq_name_arr=( 1050 1250 1450 1650   )
...
run_dir="/project/ahisq/yannis_puregauge/runs/runspechisqtunl1648b694635x139939a"
submit_dir="/project/ahisq/yannis_puregauge/submits/subspechisqtunl1648b694635x139939a"
