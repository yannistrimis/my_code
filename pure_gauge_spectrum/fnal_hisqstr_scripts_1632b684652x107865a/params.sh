...
out_name="spechisqstr1632b684652x107865"

nmasses=4
mass_arr=( 0.04 0.06 0.08 0.10   )
...
run_dir="/project/ahisq/yannis_puregauge/runs/runspechisqstrl1632b684652x107865a"
submit_dir="/project/ahisq/yannis_puregauge/submits/subspechisqstrl1632b684652x107865a"
