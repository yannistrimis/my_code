...
awk '$1 == "w" && $2 == "clover" { print $5,$7 }' tuning_schemes.data  > swc.data
awk '$1 == "w" && $2 == "wilson" { print $5,$7 }' tuning_schemes.data  > sww.data
awk '$1 == "w" && $2 == "symanzik" { print $5,$7 }' tuning_schemes.data  > sws.data
awk '$1 == "s" && $2 == "clover" { print $5,$7 }' tuning_schemes.data  > ssc.data
